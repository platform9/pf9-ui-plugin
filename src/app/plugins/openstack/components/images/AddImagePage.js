    ...
    return (
      <Fragment>
        ...
        <Typography>
          ...
          <br />
          <b>Important</b>: Remove colons <span className={classes.code}>:</span> from image file
          names. Images with names containing colons may be falsely reported.
          <br />
          If an image is <span className={classes.code}>raw</span>, and not in a format that is
          recognized by the <span className={classes.code}>qemu-img info</span> command, it must
          ...
          have one of the following extensions: .raw, .img, .dat, .bin.
          <br />
          <b>Image Permissions</b>: Your image files must have the right permissions -
          world-readable or readable to <span className={classes.code}>company-name</span> user and{' '}
...
export default compose(requiresAuthentication, withRouter, withStyles(styles))(AddImagePage)
