                    ...
                    >
                      {({ data }) => (
                        <VolumeSnapshotChooser
                          data={data}
                          onChange={value =>
                            setWizardContext({ snapshot_id: value })
                          }
                    ...
                    <DataLoader dataKey="volumes" loaderFn={loadVolumes}>
                      {({ data }) => (
                        <VolumeChooser
                          data={data}
                          onChange={value =>
                            setWizardContext({ volume_id: value })
                          }
                    ...
                    <DataLoader dataKey="images" loaderFn={loadImages}>
                      {({ data }) => (
                        <ImageChooser
                          data={data}
                          onChange={value =>
                            setWizardContext({ imageRef: value })
                          }
                    ...
                    >
                      ...
                      {createMultiple && (
                        <React.Fragment>
                          ...
                          />
                          <br />
                          {schemaSamples(prefix, Math.min(numVolumes, 3)).map(
                            str => (
                              <div key={str}>{str}</div>
                            )
                          )}
