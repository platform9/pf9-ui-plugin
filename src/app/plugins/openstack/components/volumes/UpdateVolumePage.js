...
const UpdateVolumePage = (props) => (
  <DataUpdater loaderFn={loadVolumes} updateFn={updateVolume} objId={props.match.params.volumeId}>
    {({ data, onSubmit }) => (
...
export default compose(requiresAuthentication)(UpdateVolumePage)
