...
OpenStack.registerPlugin = pluginManager => {
  pluginManager.registerRoutes('/ui/openstack', [
    {
      name: 'Dashboard',
    ...
    },
    {
      ...
      link: {
        path: '/storage/volumeSnapshots/edit/:volumeSnapshotId',
        exact: true,
      },
  ...
  pluginManager.registerNavItems('/ui/openstack', [
