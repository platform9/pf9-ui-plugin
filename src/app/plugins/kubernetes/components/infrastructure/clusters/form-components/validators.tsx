...
export const IPValidator = customValidator((value, formValues) => {
...
export const containerAndServicesIPEqualsValidator = customValidator((value, formValues) => {
...
export const cidrBlockSizeValidator = customValidator((value) => {
