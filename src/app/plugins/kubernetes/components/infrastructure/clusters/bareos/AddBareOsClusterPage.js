                      ...
                      <FormFieldCard title="Networking Details">
                        <div className={classes.inputWidth}>
                          ...
                          <TextField
                            id="httpProxy"
                            label="HTTP Proxy"
                            info={<div className={classes.inline}>(Optional) Specify the HTTP proxy for this cluster. Uses format of <CodeBlock><span>{'<scheme>://<username>:<password>@<host>:<port>'}</span></CodeBlock> where username and password are optional.</div>}
                          />
                          <PicklistField
                            id="networkPlugin"
