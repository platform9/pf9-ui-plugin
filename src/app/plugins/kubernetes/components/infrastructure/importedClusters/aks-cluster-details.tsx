...
import ClusterNodes from './aks-nodes'
import ClusterDetails from './aks-details'
...
const AKSClusterDetails = ({ cluster, reload, loading }) => {
    ...
    <>
      ...
      <Tabs>
        <Tab value="node-groups" label="Node Groups">
          {clusterHeader}
          <AgentPools cluster={cluster} reload={reload} loading={loading} />
        </Tab>
...
export default AKSClusterDetails
