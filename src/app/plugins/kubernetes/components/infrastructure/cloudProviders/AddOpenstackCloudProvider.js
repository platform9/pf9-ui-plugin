...
const helpText = (
  <Typography variant="body1" component="div">
    ...
    <p>
      You can create multiple OpenStack cloud providers - each OpenStack cloud provider should be
      associated with unique OpenStack credentials.
    </p>
    <Alert variant="info">
      <div>
        <p>
...
const keyStoneUrlInfo = (
  <div>
    ...
    https://company.platform9.net/keystone/v3.
    <br />
    <br />
    NOTE: We currently require that the OpenStack endpoint you use for this be a Platform9 Managed
    OpenStack endpoint. Contact support@platform9.com if you have any further questions about this
  </div>
)
    ...
    <>
      ...
      <ValidatedForm onSubmit={onComplete} initialValues={initialValues}>
        ...
        <TextField
          ...
          id="password"
          label="Password"
          info="Specify password for the OpenStack user specified above"
        />
        <TextField
          required
          id="projectName"
