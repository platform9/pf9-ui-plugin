        ...
        <div className={classes.formWidth}>
          <FormFieldCard title="Create Azure Cloud Provider">
            <Typography variant="body1" component="div">
              <p>
                Create a new cloud provider for your Microsoft Azure public cloud. This cloud
                provider will work using your existing Azure credentials to create and manage
                Kubernetes clusters and associated resources within your Azure public cloud
                environment.
              </p>
              <p>
              ...
              <Alert variant="info">
                <div>
                  <p>
                    ...
                    requires access must be represented by a new or existing security principal. The
                    security principal defines the access policy and permissions for the
                    user/application in the Azure AD tenant. In order to be able to perform the
                    necessary operations on Managed Kubernetes clusters, your credentials must have
                    a 'contributor' role assigned, or a similar read/write role where the user is
                    able to access subscriptions, and create/update/delete Azure resources. See{' '}
                    <ExternalLink url={azureServicePrincipalPortalLink}>this article</ExternalLink>{' '}
                    for detailed steps.
                  </p>
                  <p>
                    ...
                    to find the tenant and client IDs.
                  </p>
                  <p>
                    A client secret must be present before creating an Azure cloud provider. To
                    learn more about creating a client secret, see{' '}
