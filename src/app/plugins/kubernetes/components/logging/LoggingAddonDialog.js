...
const LoggingAddonDialog = ({ rows: [cluster], onClose }) => {
  ...
  const toggleLogging = useCallback(async () => {
    try {
      ...
      const logPkg = pkgs.find((pkg) => pkg.name === 'pf9-log')
  ...
  return (
    <Dialog open onClose={onClose}>
      ...
      <DialogContent>
        ...
        <p>
          After enabling logging add-on, you will be able to forward logs generated by Kubernetes
          components and user applications to log datastores such as Elasticsearch and S3.
        </p>
      </DialogContent>
      <DialogActions>
