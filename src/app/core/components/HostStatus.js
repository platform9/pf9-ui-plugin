...
const getTimeDriftSupportLink = (host) =>
  isDebian(host)
...
const HostStatus = ({ host = {} }) => {
  ...
  const getStatusContents = objSwitchCase(
    {
      ...
      offline: (
        <>
          ...
          Offline since {host.lastResponse}
        </>
      ),
      ...
      pending: (
        <>
          <i className={clsx(classes.loading, 'fal fa-lg fa-spin fa-sync')} />
          Discovering
        </>
      ),
      ...
      error: (
        <>
          <WarningIcon style={orangeStyle} />
          Error authorizing host. Please contact support.
        </>
      ),
      ...
      'invalid-credentials': (
        <>
          <WarningIcon style={orangeStyle} />
          Error connecting to vCenter. Please{' '}
          <a href="#/infrastructure/vmware">update your credentials</a>.
        </>
      ),
      ...
      'insufficient-permissions': (
        <>
          <WarningIcon style={yellowStyle} />
          Cannot verify vCenter permissions. Please{' '}
          <a href="#/infrastructure/vmware">ensure you have sufficient permissions</a>.
        </>
      ),
    },
  ...
  return (
    <div className={classes.root}>
      ...
      {supportRole && (
        <div className={classes.supportRole}>
