...
describe('Value Formatters Test', () => {
  ...
  it('Value with output unit', () => {
    ...
    expect(formattedValue(448115464604563263.36, 'GB', 8)).toEqual(
      '417,340,048.22053319 GB'
    )
    expect(formattedValue(448115464604563263.36, 'TB', 1)).toEqual(
      '407,558.6 TB'
    )
  ...
  it('Input error handling', () => {
    ...
    expect(formattedValue(1024, 'KB', -1)).toEqual(
      'Invalid decimal digits input.'
    )
  })
})
