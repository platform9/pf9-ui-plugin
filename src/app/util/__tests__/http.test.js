  ...
  describe('json', () => {
    describe('post', () => {
      ...
      it('should parse JSON in the response', async () => {
        ...
        const response = await http.json.post('http://somewhere.com', {
          foo: 'ignore-me',
        })
  ...
  describe('authenticated', () => {
    describe('get', () => {
      it('should have the x-auth-token set in the request header', async () => {
        const mockedFetch = jest
          .fn()
          .mockResolvedValue({ json: () => Promise.resolve(null) })
        global.fetch = mockedFetch
    ...
    describe('post', () => {
      ...
      it('should return the JSON body directly', async () => {
        fetch.mockResponseOnce(JSON.stringify({ foo: 'bar' }))
        const response = await http.authenticated.openstack.post(
          'http://somewhere.com',
          { foo: 'ignore-me' }
        )
